function K = estimate_kernel_v2(B, opt)

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% blind kernel estimation from multiple image.
%%
%% Try to use Alternating Minimization for kernel estimation
%% Goal: min_{k,u,g,w} ||B2 * k1 - B1 * k2||^2 + mu1|| Ck - e ||^2 + mu2||k - u||^2 
%%   + mu3||(dx)k - gx ||^2 + mu3||(dy)k - gy||^2 + mu4||k-w||^2 
%%   + lam1||u||_0 + lam2||gx||_0 + lam2||gy||_0 + h(w) 
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
